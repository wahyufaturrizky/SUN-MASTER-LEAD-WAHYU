                    ...
                    <div class='tuna-signup-right col-md-12 col-sm-12 '>
                        ...
                        <div class="tuna-steps">
                            ...
                            <div class="step" data-step-id='6'>
                                ...
                                <div class="inputDivider">
									<label class="formLabel" for="tn_school_name">Know us from?</label>
									<Dropdown
										...
										:maxItem="10"
										placeholder="Type to search know us from">
									</Dropdown>
									<input hidden type="text" id="tn_marketing_source" name="tn_marketing_source" v-model="selectedMarketing" v-validate="'required'" data-vv-as="Know us from?" />
									<div class='help-error help-error-marketing-source'>{{ errors.first('tn_marketing_source') }}</div>
								</div>
                            </div>
                            ...
                            <div class="step step-confirm" data-step-id='7'>
                                <form v-on:submit.prevent="onSubmit" v-on:keyup.enter="onSubmit" name='signupForm' autocomplete="off" class="form-horizontal">
									...
									<div class="form-group">
                                        ...
                                        <div class="col-md-8">
                                            <div class="input-container">
                                                <input type="text" maxlength="16" id="ck_parents_phone" name="ck_parents_phone" autocomplete="nope" spellcheck="false" class="form-control" @keypress="phoneValidator" v-model="student.parents.phone" v-validate="'required|min:10|max:16'" data-vv-as="Parents Phone" />
                                    ...
                                    <div class="form-group">
                                        <div class="control-label col-md-4">Current Education Grade</div>
                                        <div class="col-md-8">
                                            <div class="input-container">
                                                <Dropdown
													class="review"
												...
												<input hidden type="text" id="ck_edu_grade" name="ck_edu_grade" v-model="selectedEdu" v-validate="'required'" data-vv-as="Current Education Grade" />
                                    ...
                                    <div class="form-group">
                                        <div class="control-label col-md-4">Know us from?</div>
                                        <div class="col-md-8">
                                            <div class="input-container">
												<Dropdown
													class="review"
												...
												<input hidden type="text" id="ck_marketing_source" name="ck_marketing_source" v-model="selectedMarketing" v-validate="'required'" data-vv-as="Know us from?" />
...
<script>
	...
	export default {
		name: 'SunEngAdvanced',
		metaInfo: {
			title: 'Advanced Mode ! - Sun English Web'
		},
		data() {
			return {
				program_name: '',
					...
					try {
						switch(nextStep) {
                            ...
                            case 6:
                                ...
                                vm.$validator.validate('tn_marketing_source')
								resolve()
                                break;
			...
			submitStatus(data) {
				...
				if (isSuccess) {
					swal({
						...
						text: "A confirmation email has been sent,<br/>Please check your email to receive the updates.",
						type: "success",
