...
<script>
	...
	export default {
		name: 'SunEngSchedule',
		metaInfo: {
			title: 'More Information ! - Sun English'
		},
		data() {
			return {
				program_name: '',
		...
		created() {
			...
			this.program_name = this.$route.params.type

			if(this.$route.params.type == 'toefl' || this.$route.params.type == 'ielts'){
				this.programs = [
									{
										id: "IELTS",
										name: "IELTS"
		...
		methods: {
			...
			onSubmit() {
				...
				if (result) {
					...
					this.$route.params.type == "toefl" ? registration_type = "sun-eng-intl-toefl" : registration_type = "sun-eng-intl-ielts"
