			...
			<div class='container-fluid'>
				<div class='row'>
                    <div class='tuna-signup-right col-md-12 col-sm-12 '>
						<div class="row">
							<div class="col-lg-6 col-md-6 header-form-title">
                        ...
                        <div class="tuna-steps">
                            <div class="step step-active" data-step-id='1'>
								...
								<div class="inputDivider">
									...
									<input type="text" maxlength="16" class="formInput" id='tn_phone' name="tn_phone" @keypress="phoneValidator" autocomplete="nope" spellcheck="false" v-model="student.phone" v-validate="'required|min:10|max:16'" data-vv-as="No. HP" />
							...
							<div class="step" data-step-id='3'>
                                <div class="inputDivider">
									...
									<input type="text" maxlength="16" class="formInput" id='tn_parents_phone' name="tn_parents_phone" autocomplete="nope" spellcheck="false" @keypress="phoneValidator" v-model="student.parents.phone" v-validate="'required|min:10|max:16'" data-vv-as="No. Orang Tua" />
								...
								<div class="inputDivider">
									...
									<input type="text" maxlength="16" class="formInput" id='tn_home_phone' name="tn_home_phone" autocomplete="nope" spellcheck="false" v-model="student.phone_home" @keypress="phoneValidator" v-validate="'required|min:10|max:16'" data-vv-as="Telp. Rumah/Kantor" />
							...
							<div class="step" data-step-id='5'>
								...
								<div class="inputDivider">
									<label class="formLabel active" for="tn_destination">Negara Tujuan</label>
									<Dropdown
										:options="student.destOfStudy"
										v-on:selected="setDestination"
										v-on:filter="searchDestination"
										:disabled="false"
										:selectedItem="student.destination"
										:maxItem="10"
										placeholder="Ketik untuk mencari negara tujuan">
									</Dropdown>
									<input hidden type="text" id="tn_destination" name="tn_destination" v-model="selectedDestination" v-validate="'required'" data-vv-as="Negara Tujuan" />
									<div class='help-error help-error-destination'>{{ errors.first('tn_destination') }}</div>
								</div>

								<div class="inputDivider">
									<label class="formLabel active" for="tn_program">Tingkat Studi</label>
									<Dropdown
										:options="student.programList"
										v-on:selected="setProgram"
										v-on:filter="searchProgram"
										:disabled="false"
										:selectedItem="student.program"
										:maxItem="10"
										placeholder="Ketik untuk mencari tingkat studi">
									</Dropdown>
									<input hidden type="text" id="tn_program" name="tn_program" v-model="selectedProgram" v-validate="'required'" data-vv-as="Tingkat Studi" />
							...
							<div class="step" data-step-id='6'>
								<div class="inputDivider">
									<label class="formLabel" for="tn_major">Jurusan Studi</label>
									<input type="text" class="formInput" id='tn_major' name="tn_major" autocomplete="nope" spellcheck="false" v-model="student.major_interest" v-validate="'required'" data-vv-as="Jurusan Studi" />
									<div class='help-error help-error-major'>{{ errors.first('tn_major') }}</div>
								</div>
							...
							<div class="step" data-step-id='7'>
								...
								<div class="inputDivider">
									...
									<label class="radio-inline"><input type="radio" v-bind:value="true" name="tn_contact_sun" v-model="student.contact_sun"> Ya</label>
									<label class="radio-inline"><input type="radio" v-bind:value="false" name="tn_contact_sun" checked v-model="student.contact_sun"> Tidak</label>
									<div class='help-error help-error-contact'>{{ errors.first('tn_contact_sun') }}</div>
								</div>
							</div>

                            <div class="step step-confirm" data-step-id='8'>
                                <form v-on:submit.prevent="onSubmit" v-on:keyup.enter="onSubmit" name='signupForm' autocomplete="off" class="form-horizontal">
									...
									<div class="form-group">
                                        ...
                                        <div class="col-md-8">
                                            <div class="input-container">
                                                <input type="text" maxlength="16" id="ck_phone" name="ck_phone" autocomplete="nope" spellcheck="false" class="form-control" @keypress="phoneValidator" v-model="student.phone" v-validate="'required|min:10|max:16'" data-vv-as="No. HP" />
												<div class='help-error help-error-phone'>{{ errors.first('tn_phone') }}</div>
                                                <a href="javascript:void(0)" class="editInput">EDIT</a>
                                            </div>
                                        </div>
									...
									<div class="form-group">
                                        ...
                                        <div class="col-md-8">
                                            <div class="input-container">
                                                <input type="text" maxlength="16" id="ck_parents_phone" name="ck_parents_phone" autocomplete="nope" spellcheck="false" class="form-control" @keypress="phoneValidator" v-model="student.parents.phone" v-validate="'required|min:10|max:16'" data-vv-as="No. Orang Tua" />
									...
									<div class="form-group">
                                        ...
                                        <div class="col-md-8">
                                            <div class="input-container">
                                                <input type="text" maxlength="16" id="ck_phone_home" name="ck_phone_home" autocomplete="nope" spellcheck="false" class="form-control" v-model="student.phone_home" @keypress="phoneValidator" v-validate="'required|min:10|max:16'" data-vv-as="Telp. Rumah/Kantor" />
									...
									<div class="form-group">
                                        <div class="control-label col-md-4">Negara Tujuan</div>
                                        <div class="col-md-8">
                                            <div class="input-container">
                                                <Dropdown
													class="review"
												...
												<input hidden type="text" id="ck_destination" name="ck_destination" v-model="selectedDestination" v-validate="'required'" data-vv-as="Negara Tujuan" />
												<div class='help-error help-error-destination'>{{ errors.first('ck_destination') }}</div>
                                                <a href="javascript:void(0)" class="editInput">EDIT</a>
                                            </div>
                                        </div>
                                    </div>
									<div class="form-group">
                                        <div class="control-label col-md-4">Tingkat Studi</div>
                                        <div class="col-md-8">
                                            <div class="input-container">
                                                <Dropdown
													class="review"
												...
												<input hidden type="text" id="ck_program" name="ck_program" v-model="selectedProgram" v-validate="'required'" data-vv-as="Tingkat Studi" />
									...
									<div class="form-group">
                                        <div class="control-label col-md-4">Jurusan Studi</div>
                                        <div class="col-md-8">
                                            <div class="input-container">
                                                <input type="text" id="ck_major" name="ck_major" autocomplete="nope" spellcheck="false" class="form-control" v-model="student.major_interest" v-validate="'required'" data-vv-as="Jurusan Studi" />
												<div class='help-error help-error-major'>{{ errors.first('ck_major') }}</div>
                                                <a href="javascript:void(0)" class="editInput">EDIT</a>
                                            </div>
                                        </div>
                                    </div>
...
<script>
	...
	export default {
		...
		updated() {
			...
			$('input[name=ck_dest_drop]').val(destination.name)
			$('input[name=ck_program_drop]').val(program.name)
			$('input[name=ck_year_drop]').val(plan_year.name)
			$('input[name=ck_offices_drop]').val(office.name)
			$('input[name=ck_marketing_drop]').val(marketing_source.name)
		},
		methods: {
			...mapActions({
				...
				getDestinationStudy: 'firstForm/getDestinationStudy',
				getProgramList: 'firstForm/getProgramList',
			...
			nextStep() {
				...
				switch(nextStep) {
					...
					case 6:
						setTimeout(() => document.getElementById('tn_major').focus(), 800)
						break;
					...
					try {
						switch(nextStep) {
							...
							case 6:
								...
								vm.$validator.validate('tn_destination')
								vm.$validator.validate('tn_program')
								resolve()
								break;

							case 7:
								vm.$validator.validate('tn_major')
			...
			setZipcode(selected) {
				...
				$('input[name=tn_zip_drop]').val(selected.name)
			...
			setDestination(selected) {
				this.student.destination = selected
				$('input[name=ck_dest_drop]').val(selected.name)
			},
			searchDestination(query) {
			},
			setProgram(selected) {
				this.student.program = selected
			...
			onSubmit() {
				...
				if (result) {
					...
					const dataToSend = {
						registration_type: 'sun-edu-general-registration',
						full_name: name,
						email,
						mobile: phone,
						birth,
						...
						destination_of_study_id: destination.id,
						highest_edu_id: edu_grade.id,
						program_interested_id: program.id,
						major_interested: major_interest,
		...
		// watch: {
		// 	student.birthDate.day: function({val, $event}) {
		// 		console.log($event)
		// 	},
		// 	// student.birthDate.month: function(val) {
		// 	// 	val ? this.student.birth = `${this.day} / ${val} / ${this.year}` : this.student.birth = ""
		// 	// },
		// 	// student.birthDate.year: function(val) {
		// 	// 	val ? this.student.birth = `${this.day} / ${this.month} / ${val}` : this.student.birth = ""
		// 	// }
		// },
		mounted: function() {
			const vm = this;
