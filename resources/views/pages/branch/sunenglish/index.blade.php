    ...
    <div class="content">
        ...
        <div class="block">
            <div class="block-header block-header-default">
                <h3 class="block-title">All Branch - Sun English</h3>
                ...
                <div class="block-options">
                    <a href="{{ route('addBranchSunEnglish') }}" class="btn btn-outline-primary">
                        Add Branch - Sun English
                    </a>
                </div>
            </div>
                            ...
                            @foreach($branches as $branch)
                                <tr>
                                    ...
                                    <td class="text-center">
                                        {{-- <div class="btn-group"> --}}
                                            <a href="{{ route('editBranchSunEnglish', $branch->branch_sun_english_id) }}" class="btn btn-sm btn-alt-secondary" data-toggle="tooltip" title="Edit"><i class="si si-pencil"></i></a>
                                            <a href="{{ route('deleteBranchSunEnglish', $branch->branch_sun_english_id) }}" class="btn btn-sm btn-alt-secondary" data-toggle="tooltip" title="Delete"><i class="si si-trash"></i></a>
                                        {{-- </div> --}}
                                    </td>
                                </tr>
                            @endforeach
