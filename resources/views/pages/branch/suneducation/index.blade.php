    ...
    <div class="content">
        ...
        <div class="block">
            <div class="block-header block-header-default">
                <h3 class="block-title">All Branch - Sun Education</h3>
                ...
                <div class="block-options">
                    <a href="{{ route('addBranchSunEducation') }}" class="btn btn-outline-primary">
                        Add Branch - Sun Education
                    </a>
                </div>
            </div>
                            ...
                            @foreach($branches as $branch)
                                <tr>
                                    ...
                                    <td class="text-center">
                                        {{-- <div class="btn-group"> --}}
                                            <a href="{{ route('editBranchSunEducation', $branch->branch_sun_education_id) }}" class="btn btn-sm btn-alt-secondary" data-toggle="tooltip" title="Edit"><i class="si si-pencil"></i></a>
                                            <a href="{{ route('deleteBranchSunEducation', $branch->branch_sun_education_id) }}" class="btn btn-sm btn-alt-secondary" data-toggle="tooltip" title="Delete"><i class="si si-trash"></i></a>
                                        {{-- </div> --}}
                                    </td>
                                </tr>
                            @endforeach
