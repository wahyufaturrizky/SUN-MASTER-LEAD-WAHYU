            ...
            <div class="col-md-6">
                ...
                <div class="block">
                    <div class="block-header block-header-default">
                        <h3 class="block-title">Edit - {{ $institutionGroup->institution_group_name }}</h3>
                    ...
                    <div class="block-content">
                        <form action="{{ route('updateInstitutionGroup') }}" method="POST">
                            @csrf
                            <input type="hidden" value="{{ $institutionGroup->institution_id }}" name="institution_id">

                            @include('pages.institution.group.partials.form')
