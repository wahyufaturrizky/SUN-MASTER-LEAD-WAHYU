            ...
            <div class="col-md-8">
                ...
                <div class="block">
                    <div class="block-header block-header-default">
                        <h3 class="block-title">Delete Event - {{ $event->event_name }}</h3>
                    ...
                    <div class="block-content">
                        <form action="{{ route('confirmDeleteEvent', $event->event_id) }}" method="POST">
                            @csrf
                            @php
                                $disabled = 'disabled';
                            @endphp
                            @include('pages.event.partials.form.event', compact('disabled'))

                            <div class="form-group row">
                                <div class="col-6">
                                    <a href="{{ route('getDataByTypeEvents', ['slug' => $event->eventType->slug]) }}" class="btn btn-alt-secondary pull-left"><i class="si si-arrow-left"></i> Back</a>
                                </div>
                                <div class="col-6">
                                    <button type="submit" class="btn btn-alt-primary pull-right"><i class="si si-check"></i> Yes, Delete this Event</button>
                                </div>
                            </div>
                        </form>
                    </div>
