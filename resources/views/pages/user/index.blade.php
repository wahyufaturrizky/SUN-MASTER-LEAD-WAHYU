    ...
    <div class="content">
        ...
        <div class="block">
            <div class="block-header block-header-default">
                ...
                <div class="block-options">
                    <a href="{{ route('addUser') }}" class="btn btn-outline-primary">
                        Add User
                    </a>
                </div>
            </div>
                        ...
                        @else
                            @foreach($users as $user)
                                <tr>
                                    ...
                                    <td class="font-w600">{{ implode($user->roles->pluck('name')->toArray(),', ') }}</td>
                                    <td class="text-center">
                                        {{-- <div class="btn-group"> --}}
                                            <a href="{{ route('editUser', $user->id) }}" class="btn btn-sm btn-alt-secondary" data-toggle="tooltip" title="Edit"><i class="si si-pencil"></i></a>
                                            <a href="{{ route('deleteUser', $user->id) }}" class="btn btn-sm btn-alt-secondary" data-toggle="tooltip" title="Delete"><i class="si si-trash"></i></a>
                                        {{-- </div> --}}
                                    </td>
                                </tr>
                            @endforeach
