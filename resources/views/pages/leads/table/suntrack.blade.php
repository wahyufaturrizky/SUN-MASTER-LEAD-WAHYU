...
<div class="block">
    <div class="block-header block-header-default">
        <h3 class="block-title">Suntrack</h3>
            ...
            <tbody>
                @foreach($leads as $lead)
                    ...
                    <tr>
                        ...
                        <td class="d-none d-sm-table-cell">{{ $lead->mobile_phone }}</td>
                        ...
                        <td class="text-center">
                            <a href="{{ route('getDataByID',['type' => 'suntrack', 'id' => $lead->leads_id]) }}" class="btn btn-sm btn-alt-secondary" data-toggle="tooltip" title="View">
