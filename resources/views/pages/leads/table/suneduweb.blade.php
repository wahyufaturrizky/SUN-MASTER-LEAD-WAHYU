...
<div class="block">
    <div class="block-header block-header-default">
        <h3 class="block-title">Sun Education Website</h3>
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            {{-- <div class="btn-group"> --}}
                                ...
                                <a href="{{ route('getDataByID',['type' => 'sun-edu-web', 'id' => $lead->registration_id]) }}" class="btn btn-sm btn-alt-secondary" data-toggle="tooltip" title="View">
