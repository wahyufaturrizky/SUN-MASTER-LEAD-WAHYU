...
<div class="block">
    <div class="block-header block-header-default">
        <h3 class="block-title">Info Session - {{ $lead->full_name }} - {{ $lead->leads_id }}</h3>
...
<div class="block">
        <div class="block-header block-header-default">
            <h3 class="block-title">Info Session - {{ $lead->studentName }} -
                {{-- {{ $lead->leads_id }} --}}
            </h3>
            <div class="block-options hide d-none">
                <button type="button" class="btn-block-option">
        ...
        <div class="block-content">
            <form action="be_forms_elements_material.html" method="post" onsubmit="return false;">
                ...
                <div class="form-group row">
                    <div class="col-md-9">
                        <div class="form-material">
                            <input value="{{ $lead->mobilePhone }}" type="text" class="form-control" id="mobile" name="mobile" placeholder="" {{ $disabled ? 'disabled' : '' }}>
                            <label for="mobile">Mobile Phone</label>
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group row">
                    <div class="col-md-9">
                        <div class="form-material">
                            <input value="{{ $lead->dateBirth }}" type="text" class="form-control" id="birth" name="birth" placeholder="" {{ $disabled ? 'disabled' : '' }}>
                            <label for="birth">Date of Birth</label>
                        </div>
                    </div>
                </div>
                <div class="form-group row">
                    <div class="col-md-9">
                        <div class="form-material">
                            <input value="{{ $lead->parentsName }}" type="text" class="form-control" id="parent-name" name="parent-name" placeholder="" {{ $disabled ? 'disabled' : '' }}>
                            <label for="parent-name">Parent's Name</label>
                        </div>
                    </div>
                </div>
                <div class="form-group row">
                    <div class="col-md-9">
                        <div class="form-material">
                            <input value="{{ $lead->parentsMobilePhone }}" type="text" class="form-control" id="parents-mobile-phone" name="parents-mobile-phone" placeholder="" {{ $disabled ? 'disabled' : '' }}>
                            <label for="parents-mobile-phone">Parents Mobile Phone</label>
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group row">
                    <div class="col-12">
                        <div class="form-material">
                            <textarea class="form-control" id="full-address" name="full-address" readonly="readonly" rows="3" placeholder="Please add a comment">{{ $lead->fullAddress }}</textarea {{ $disabled ? 'disabled' : '' }}>
                            <label for="full-address">Full Address</label>
                        </div>
                    </div>
                </div>
                <div class="form-group row">
                    <div class="col-md-9">
                        <div class="form-material">
                            <input value="{{ $lead->postCode }}" type="text" class="form-control" id="postal-code" name="postal-code" placeholder="" {{ $disabled ? 'disabled' : '' }}>
                            <label for="postal-code">Post Code/ City Area</label>
                        </div>
                    </div>
                </div>
                <div class="form-group row">
                    <div class="col-md-9">
                        <div class="form-material">
                            <input value="{{ $lead->homeAddressPhone }}" type="text" class="form-control" id="phone" name="phone" placeholder="" {{ $disabled ? 'disabled' : '' }}>
                            <label for="phone">Home Address Phone</label>
                        </div>
                    </div>
                </div>
                <div class="form-group row">
                    <div class="col-md-9">
                        <div class="form-material">
                            <input value="{{ $lead->educationGrade }}" type="text" class="form-control" id="highest-edu" name="highest-edu" placeholder="" {{ $disabled ? 'disabled' : '' }}>
                            <label for="highest-edu">Current Education Grade</label>
                        </div>
                    </div>
                </div>
                <div class="form-group row">
                    <div class="col-md-9">
                        <div class="form-material">
                            <input value="{{ $lead->previousCurrentSchool }}" type="text" class="form-control" id="precur-school" name="precur-school" placeholder="" {{ $disabled ? 'disabled' : '' }}>
                            <label for="precur-school">Previous / Current School</label>
                        </div>
                    </div>
                </div>
                <div class="form-group row">
                    <div class="col-md-9">
                        <div class="form-material">
                            <input value="{{ $lead->majorInterested }}" type="text" class="form-control" id="major-interested" name="major-interested" placeholder="" {{ $disabled ? 'disabled' : '' }}>
                            <label for="major-interested">Major Interested</label>
                        </div>
                    </div>
                </div>
                <div class="form-group row">
                    <div class="col-md-9">
                        <div class="form-material">
                            <input value="{{ $lead->destinationStudy }}" type="text" class="form-control" id="destination-of-study" name="destination-of-study" placeholder="" {{ $disabled ? 'disabled' : '' }}>
                            <label for="destination-of-study">Destination of Study</label>
                        </div>
                    </div>
                </div>
                <div class="form-group row">
                    <div class="col-md-9">
                        <div class="form-material">
                            <input value="{{ $lead->programInterested }}" type="text" class="form-control" id="program-interested" name="program-interested" placeholder="" {{ $disabled ? 'disabled' : '' }}>
                            <label for="program-interested">Program Interested</label>
                        </div>
                    </div>
                </div>
                <div class="form-group row">
                    <div class="col-md-9">
                        <div class="form-material">
                            <input value="{{ $lead->planningYear }}" type="text" class="form-control" id="planning-year" name="planning-year" placeholder="" {{ $disabled ? 'disabled' : '' }}>
                            <label for="planning-year">Planning Year</label>
                        </div>
                    </div>
                </div>
                <div class="form-group row">
                    <div class="col-md-9">
                        <div class="form-material">
                            <input value="{{ $lead->knowThisEvent }}" type="text" class="form-control" id="marketing-source" name="marketing-source" placeholder="" {{ $disabled ? 'disabled' : '' }}>
                            <label for="marketing-source">Marketing Source</label>
                        </div>
                    </div>
                </div>
                <div class="form-group row">
                    <div class="col-md-9">
                        <div class="form-material">
                            <input value="{{ $lead->office }}" type="text" class="form-control" id="has-contact-sun" name="has-contact-sun" placeholder="" {{ $disabled ? 'disabled' : '' }}>
                            <label for="has-contact-sun">Ever Contact SUN Office?</label>
                        </div>
                    </div>
                </div>
