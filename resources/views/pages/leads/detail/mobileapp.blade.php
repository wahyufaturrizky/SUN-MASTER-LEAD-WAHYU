...
<div class="block">
    <div class="block-header block-header-default">
        <h3 class="block-title">Mobile App - {{ $lead->name }}</h3>
    ...
    <div class="block-content">
        <form action="be_forms_elements_material.html" method="post" onsubmit="return false;">
            <div class="form-group row">
                <div class="col-md-9">
                    <div class="form-material">
                        <input value="{{ $lead->apply_id }}" type="text" class="form-control" id="leads-id" name="leads-id" placeholder="" {{ $disabled ? 'disabled' : '' }}>
            ...
            <div class="form-group row">
                <div class="col-md-9">
                    <div class="form-material">
                        <input value="{{ $lead->full_name }}" type="text" class="form-control" id="name" name="name" placeholder="" {{ $disabled ? 'disabled' : '' }}>
            ...
            <div class="form-group row">
                <div class="col-md-9">
                    <div class="form-material">
                        <input value="{{ $lead->phone2 }}" type="text" class="form-control" id="phone" name="phone" placeholder="" {{ $disabled ? 'disabled' : '' }}>
