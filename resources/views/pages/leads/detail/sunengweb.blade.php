...
<div class="block">
    <div class="block-header block-header-default">
        <h3 class="block-title">Sun English Web - {{ $lead->full_name }} - {{ $lead->registration_id }}</h3>
    ...
    <div class="block-content">
        <form action="be_forms_elements_material.html" method="post" onsubmit="return false;">
            ...
            <div class="form-group row">
                <div class="col-12">
                    <div class="form-material">
                        <textarea class="form-control" id="full-address" readonly="readonly" name="full-address" rows="3" placeholder="Please add a comment">{{ $lead->address }}</textarea {{ $disabled ? 'disabled' : '' }}>
