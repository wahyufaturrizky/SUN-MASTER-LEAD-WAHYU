                ...
                <div class="content">
                    <div class="block">
                        ...
                        <div class="block-content">
                            ...
                            <h4 class="text-center">Registration ID: {{ $register_id['id'] }}</h4>
                        </div>
                        <hr class="hr-sm my-1">
                        <div class="block-content">
                            <div class="row">
                                <div class="col-12">
                                    <a href="{{ route('linkRegistrationEventGroup', ['event_group_id' => $eventGroup->event_group_id, 'slug' => $eventGroup->slug, 'lang_id' => 'en']) }}" target="_blank" class="btn btn-alt-secondary mx-1 text-center mb-4" data-toggle="tooltip" title="Back to Registration Page">Back to Registration Page</a>
                                </div>
                            </div>
                        </div>
                    </div>
