                ...
                <div class="content">
                    <div class="block" style="min-height:900px;">
                        <div class="block-header block-header-default" style="background-color:#cccccc">
                            <h3 class="block-title text-center"><strong>Registration - {{ $eventGroup->event_group_name }}</strong></h3>
                        </div>
                        ...
                        <div class="block-content">
                            <!-- Main Form -->
                            <form action="{{ route('applyEventGroup',['event_group_id' => $eventGroup->event_group_id]) }}" method="POST" autocomplete="off">
                                <div class="col-md-12">
                                    <div class="row">
                                        @csrf
                                        <div class="form-group col-md-6">
                                            <div class="form-material">
                                                ...
                                                <input type="text" class="form-control" id="full_name" name="full_name" placeholder="Please enter your full name" autocomplete="off" required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group col-md-6">
                                            <div class="form-material">
                                                ...
                                                <select class="js-select2 form-control" id="gender" name="gender" required>
                                        ...
                                        <div class="form-group col-md-6">
                                            <div class="form-material">
                                                ...
                                                <select class="js-select2 form-control" id="planning_year" name="planning_year" required>
                                                    <option value="">Select one</option>
                                        ...
                                        <div class="form-group col-md-6">
                                            <div class="form-material">
                                                ...
                                                <select class="js-select2 ajaxPostalCode form-control" id="postal_code_id" name="postal_code_id" data-placeholder="Select one"></select>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group col-md-6">
                                            <div class="form-material">
                                                ...
                                                <select class="js-select2 form-control" id="has_contact_sun" name="has_contact_sun" required>
                                                    <option value="">Select one</option>
                                        ...
                                        <div class="form-group col-md-6">
                                            <div class="form-material" id="try">
                                                ...
                                                <select class="js-select2 form-control" id="branch_id" name="branch_id" data-placeholder="Select one">
                                                    <option value="">Select one</option><!-- Required for data-placeholder attribute to work with Select2 plugin -->
                                        ...
                                        <div class="form-group col-md-6">
                                            <div class="form-material" id="try">
                                                ...
                                                <select class="js-select2 form-control" id="event_ids" name="event_ids" data-placeholder="Select one" multiple>
                                                    <option value="">Select one</option><!-- Required for data-placeholder attribute to work with Select2 plugin -->
