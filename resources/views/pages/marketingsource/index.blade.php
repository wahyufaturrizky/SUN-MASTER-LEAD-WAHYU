    ...
    <div class="content">
        ...
        <div class="block">
            <div class="block-header block-header-default">
                <h3 class="block-title">All Marketing Source</h3>
                ...
                <div class="block-options">
                    <a href="{{ route('addMarketingSource') }}" class="btn btn-outline-primary">
                    ...
                    <tbody>
                        ...
                        @else
                            @foreach($marketingSources as $marketingSource)
                                <tr>
                                    <td class="text-center">{{ (($marketingSources->currentPage() - 1 ) * $marketingSources->perPage() ) + $loop->iteration }}</td>
                                    <td class="font-w600">{{ $marketingSource->marketing_source_name }}</td>
                                    <td class="font-w600">{{ $marketingSource->register_type }}</td>
                                    <td class="text-center">
                                        {{-- <div class="btn-group"> --}}
                                            <a href="{{ route('editMarketingSource', $marketingSource->marketing_source_id) }}" class="btn btn-sm btn-alt-secondary" data-toggle="tooltip" title="Edit"><i class="si si-pencil"></i></a>
                                            <a href="{{ route('deleteMarketingSource', $marketingSource->marketing_source_id) }}" class="btn btn-sm btn-alt-secondary" data-toggle="tooltip" title="Delete"><i class="si si-trash"></i></a>
                                        {{-- </div> --}}
                                    </td>
                                </tr>
                            @endforeach
