...
class BeCompCharts {
    ...
    static initChartsChartJS() {
        ...
        // Lines/Bar/Radar Chart Data - Custom
        let chartLinesBarsRadarData2 = this.getData();

        console.log(chartLinesBarsRadarData2);
        ...
        if (chartLinesCon.length) {
            chartLines = new Chart(chartLinesCon, { type: 'line', data: chartLinesBarsRadarData2 });
        }
