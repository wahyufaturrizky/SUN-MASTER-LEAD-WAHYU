...
class CountrySeeder extends Seeder
{
    ...
    public function run()
    {
        $countries = [
            ...
            ['country_code' => 'BO','country_name' => 'Bolivia, Plurinational State of'],
            ...
            ['country_code' => 'KP','country_name' => 'Korea, Democratic Peoples Republic of'],
            ['country_code' => 'KR','country_name' => 'Korea, Republic of'],
            ['country_code' => 'KW','country_name' => 'Kuwait'],
            ['country_code' => 'KG','country_name' => 'Kyrgyzstan'],
            ['country_code' => 'LA','country_name' => 'Lao Peoples Democratic Republic'],
            ...
            ['country_code' => 'MK','country_name' => 'Macedonia, the Former Yugoslav Republic of'],
        ...
        foreach($countries as $country){
            $cou = new Country();
            $cou->country_code = $country['country_code'];
            $cou->country_name = $country['country_name'];
            $cou->save();
        }
    }
}
